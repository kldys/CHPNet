...
class CHPNet(nn.Module):
    def __init__(self):
        super(CHPNet, self).__init__()
        ...
        self.conv4 = nn.Conv2d(1, self.up_factor ** 2, kernel_size=3, stride=1, padding=1)
        self.pixel_shuffle = nn.PixelShuffle(self.up_factor)  # 新加的
    ...
    def reconnect(self, v, x, y, i):
        ...
        err1 = self.pixel_shuffle(self.conv4(down - y))
        err2 = x - v
